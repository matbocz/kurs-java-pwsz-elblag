...
public class Lab11Zad4 {
    public static void main(String[] args) throws WyjatekWypozyczona {
        Book[] b = {
...
class WyjatekWypozyczona extends Exception {
}
...
class Czytelnik {
    ...
    void wypozycz(Book ksiazka) throws WyjatekWypozyczona {

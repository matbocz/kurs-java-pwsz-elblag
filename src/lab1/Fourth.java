...
public class Fourth { //definicja klasy publicznej
    public static void main(String[] args) throws IOException { //metoda main, obsługa wyjątków
        ...
        a=sc1.nextDouble(); //przypisanie do zmienne liczby typu double wczytanej z klawiatury
        ...
        b=sc2.nextDouble(); //przypisanie do zmienne liczby typu double wczytanej z klawiatury
